...
def get_color_rgb():
    ...
    return {
        1: (21, 62, 125), 2: (114, 67, 144), 3: (255, 166, 0), 4: (26, 167, 238),
...
def get_color_rgba_norm(get_color_rgb):
    return{
        1: (21 / 255, 62 / 255, 125 / 255, 1.), 2: (114 / 255, 67 / 255, 144 / 255, 1.),
...
def get_categories_name():
    # TODO: Maybe load from the json file?
    return {
        1: 'Nucleus', 2: 'Cluster', 3: 'Satellite', 4: 'Nucleus_out_of_focus', 5: 'Overlapped_Nuclei',
