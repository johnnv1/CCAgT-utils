...
@pytest.mark.parametrize(
    'pol,bb,expected', [
        (Polygon([(0, 0), (0, 10), (10, 10), (10, 15), (15, 15)]), box(0, 0, 10, 10), Polygon([(0, 0), (0, 10), (10, 10)])),
        (Polygon([(0, 0), (0, 10), (10, 10), (10, 15), (15, 15)]), box(50, 50, 100, 100), np.nan),
        (
            Polygon([(0, 0), (0, 10), (10, 10), (10, 15), (15, 15)]), box(
                0, 0, 100, 100,
